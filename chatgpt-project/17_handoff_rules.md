...
PMO governance outputs often create work for other modules. Use a lightweight
handoff note so follow-through does not disappear between meetings.

## Handoff note format

Source module: PMO Governance Operations Log
...
| Signal in the log | Handoff target | Pass downstream |
|---|---|---|
...
## Keep inside this module

- Routine action tracking.
- Meeting prep.
- Weekly governance summaries.
- Decision/action/risk/dependency carry-forward.
- Follow-up drafts that do not require a separate review module.

## Do not pass downstream

- Raw meeting noise that has not been classified.
